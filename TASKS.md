...
- [x] **TASK-008**: Fix setState in useEffect - PipelineBoard.tsx:298
...
- [x] **TASK-010**: Fix setState in useEffect - Tooltip.tsx:83
  - File: `src/components/ui/Tooltip.tsx`
  - Line: 83
  - Action: Use useLayoutEffect or lazy state initialization
  - Estimated: 20 min

- [x] **TASK-011**: Fix ref access during render - Dropdown.tsx:83-104
...
- [x] **TASK-019**: Create withTenant higher-order function for API routes
  - File: `src/lib/api-handlers.ts` (new)
  - Action: Extract tenant lookup pattern to reusable function
  - Estimated: 1 hour

- [x] **TASK-020**: Refactor contacts/route.ts to use withTenant
  - File: `src/app/api/contacts/route.ts`
  - Estimated: 20 min

- [x] **TASK-021**: Refactor companies/route.ts to use withTenant
  - File: `src/app/api/companies/route.ts`
  - Estimated: 20 min

- [x] **TASK-022**: Refactor leads/route.ts to use withTenant
  - File: `src/app/api/leads/route.ts`
  - Estimated: 20 min

- [x] **TASK-023**: Refactor pipelines/route.ts to use withTenant
  - File: `src/app/api/pipelines/route.ts`
  - Estimated: 20 min

- [x] **TASK-024**: Refactor deals/route.ts to use withTenant
  - File: `src/app/api/deals/[id]/route.ts`
  - Estimated: 20 min

- [x] **TASK-025**: Refactor conversations/route.ts to use withTenant
  - File: `src/app/api/conversations/route.ts`
  - Estimated: 20 min

- [x] **TASK-026**: Refactor messages/route.ts to use withTenant
  - File: `src/app/api/messages/route.ts`
  - Estimated: 20 min

- [x] **TASK-027**: Refactor webhooks/whatsapp/route.ts to use withTenant
...
- [x] **TASK-028**: Add animate-shimmer animation to tailwind.config.ts
  - File: `tailwind.config.ts`
  - Action: Add shimmer keyframes and animation
  - Estimated: 15 min

- [x] **TASK-029**: Add slideInRight animation to tailwind.config.ts
  - File: `tailwind.config.ts`
  - Action: Add slideInRight keyframes
  - Estimated: 10 min

- [x] **TASK-030**: Add slideInLeft animation to tailwind.config.ts
  - File: `tailwind.config.ts`
  - Action: Add slideInLeft keyframes
  - Estimated: 10 min

- [x] **TASK-031**: Remove inline style animations from Modal.tsx
  - File: `src/components/ui/Modal.tsx`
  - Lines: 250-302
  - Action: Replace JSX style with Tailwind animation classes
  - Estimated: 30 min

- [x] **TASK-032**: Refactor Avatar.tsx to use design system colors
  - File: `src/components/ui/Avatar.tsx`
  - Lines: 30-44
  - Action: Replace blue-500, emerald-500 etc with design tokens
  - Estimated: 45 min

- [x] **TASK-033**: Add danger-hover and danger-active colors to theme
  - File: `tailwind.config.ts`
  - Action: Add hover/active variants for danger color
  - Estimated: 15 min

- [x] **TASK-034**: Add success-hover and success-active colors to theme
  - File: `tailwind.config.ts`
  - Action: Add hover/active variants for success color
  - Estimated: 15 min

- [x] **TASK-035**: Update Button.tsx danger variant to use design tokens
  - File: `src/components/ui/Button.tsx`
  - Line: 16
  - Action: Replace hover:bg-red-600 with hover:bg-danger-hover
  - Estimated: 10 min

- [x] **TASK-036**: Update Button.tsx success variant to use design tokens
  - File: `src/components/ui/Button.tsx`
  - Line: 20
  - Action: Replace hover:bg-emerald-600 with hover:bg-success-hover
  - Estimated: 10 min

- [x] **TASK-037**: Add channel-specific colors to Tailwind theme
  - File: `tailwind.config.ts`
  - Action: Create channel color group for WhatsApp, Email, Instagram etc
  - Estimated: 30 min

- [x] **TASK-038**: Update Badge.tsx channelMap to use theme colors
...
- [x] **TASK-039**: Fix impure Math.random() in Skeleton.tsx
  - File: `src/components/ui/Skeleton.tsx`
  - Line: 329
  - Action: Generate random values in useState or useMemo
  - Estimated: 20 min

- [x] **TASK-040**: Fix ChatArea.tsx useEffect dependencies
...
- [x] **TASK-041**: Fix CSRF cookie httpOnly flag
  - File: `src/middleware.ts`
  - Line: 54
  - Action: Change httpOnly: false to httpOnly: true
  - Estimated: 5 min

- [x] **TASK-042**: Add security headers to Next.js config
  - File: `next.config.ts`
...
- [x] **TASK-049**: Remove unused 'Check' import - pipelines/page.tsx
  - File: `src/app/(dashboard)/settings/pipelines/page.tsx`
  - Line: 4
  - Estimated: 2 min

- [x] **TASK-050**: Remove unused 'Calendar' import - CompanyDetailSheet.tsx
  - File: `src/components/companies/CompanyDetailSheet.tsx`
  - Line: 4
  - Estimated: 2 min

- [x] **TASK-051**: Remove unused 'Loader2' import - InboxLayout.tsx
  - File: `src/components/inbox/InboxLayout.tsx`
  - Line: 4
  - Estimated: 2 min

- [x] **TASK-052**: Remove unused 'getContactName' variable - ConversationList.tsx
...
- [x] **TASK-054**: Remove unused 'toast' variable - PipelineBoard.tsx
  - File: `src/components/pipeline/PipelineBoard.tsx`
  - Line: 275
  - Estimated: 2 min

- [x] **TASK-055**: Remove unused 'get' function - authStore.ts
...
- [x] **TASK-057**: Remove unnecessary useCallback - ContactList.tsx
  - File: `src/components/contacts/ContactList.tsx`
  - Lines: 23-30
  - Action: Convert safeParseArray to regular function
  - Estimated: 5 min

- [x] **TASK-058**: Remove unnecessary useMemo - InboxLayout.tsx
  - File: `src/components/inbox/InboxLayout.tsx`
  - Line: 47
  - Action: Replace useMemo with direct .find() call
  - Estimated: 5 min

- [x] **TASK-059**: Fix unescaped HTML entities - pipelines/page.tsx
  - File: `src/app/(dashboard)/settings/pipelines/page.tsx`
  - Line: 234
  - Action: Replace " with &quot;
  - Estimated: 5 min
...
- [x] **TASK-062**: Add arbitrary width values to Tailwind theme
  - File: `tailwind.config.ts`
  - Action: Add spacing values for 120, 260, 320, 400
  - Estimated: 15 min

- [x] **TASK-063**: Replace min-w-[320px] with design token
  - Files: Multiple (PipelineBoard.tsx, Skeleton.tsx)
  - Estimated: 15 min

- [x] **TASK-064**: Replace text-[10px] with design token
...
- [x] **TASK-066**: Create src/constants/index.ts for magic values
  - File: `src/constants/index.ts` (new)
  - Action: Extract TENANT_DOMAIN, API_TIMEOUT, TOAST_DURATION etc
  - Estimated: 30 min

- [x] **TASK-067**: Create src/utils/index.ts for helper functions
