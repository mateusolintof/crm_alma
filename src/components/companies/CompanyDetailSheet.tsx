...
import { Building2, Edit, Globe, Tag, Trash2, Users } from 'lucide-react';
    ...
    <Sheet
      ...
      footer={
        <div className="flex gap-2">
          ...
          {onEdit && (
            <Button icon={<Edit size={16} />} onClick={() => onEdit(company)}>
              Editar
            </Button>
          )}
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-text-primary">{company.size || 'Não informado'}</p>
              </div>
            </div>
